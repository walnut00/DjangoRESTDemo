...
MIDDLEWARE = [
    ...
    'api.middleware.MySessionMiddlereare',
    'api.middleware.MyAuthenticationMiddleware',# 用户权限处理中间件
    # 'django.contrib.messages.middleware.MessageMiddleware',
    'django.middleware.clickjacking.XFrameOptionsMiddleware',
    'api.middleware.UncaughtExceptionMiddleware', # 自定义中间件
]
...
# REST框架配置
REST_FRAMEWORK = {
    'DEFAULT_PAGINATION_CLASS': 'api.pagination.MyPagination',# 配置全局分页, 也可以在viewset中局部指定pagination_class
